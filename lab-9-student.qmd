...
all_simulations |>
  ...
  pivot_wider(names_from = n,
              ...
              names_prefix = "simulated_means_n_")
```
...
# Source for assigning labels to facets: https://ggplot2.tidyverse.org/reference/labeller.html
...
all_simulations |>
  ...
  facet_wrap(~ n,
            scales = "free_y",
            labeller = labeller(n = c("10" = "Sample Size = 10",
                                      "100" = "Sample Size = 100",
  ...
  geom_vline(mapping = aes(xintercept = 10),
             linetype = "dashed",
             color = "firebrick") +
  labs(title = "Distribution of Simulated Means from Different Sample Sizes",
       x = "Simulated Means",
       y = "",
       subtitle = "Frequency") +
  theme_minimal()
